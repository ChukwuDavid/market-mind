...
def generate_synthetic_candles(
    symbol: str, n: int = 200, start_price: float = 1.0850, trend: float = 0.00002
) -> list[CandleData]:
    ...
    request = AnalysisRequest(
        ...
        symbols=[
            SymbolInput(symbol="EURUSD", timeframe="1h",
                candles=generate_synthetic_candles("EURUSD", start_price=1.0850, trend=0.00002)),
            SymbolInput(symbol="USDJPY", timeframe="1h",
                candles=generate_synthetic_candles("USDJPY", start_price=152.30, trend=-0.00001)),
            SymbolInput(symbol="BTCUSD", timeframe="1h",
                candles=generate_synthetic_candles("BTCUSD", start_price=68500.0, trend=0.00005)),
        ],
        news=[
